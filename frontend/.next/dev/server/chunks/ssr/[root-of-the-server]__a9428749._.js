...
function LeadDetailPage() {
    ...
    const fetchLead = async ()=>{
        try {
            setLoading(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$leadService$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getLeadById(id);
    ...
    const handleStatusChange = async (newStatus)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$leadService$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].updateStatus(lead.id, newStatus);
        } catch (error) {
    ...
    const activitiesByDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (!lead) return {};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a9428749._.js.map