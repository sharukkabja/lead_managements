...
;
;
/* Allowed status transitions */ const STATUS_TRANSITIONS = {
    new: [
        'contacted',
        'lost'
    ],
...
function LeadDetailPage() {
    ...
    const fetchLead = async ()=>{
        try {
            setLoading(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$leadService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getLeadById(id);
    ...
    const handleStatusChange = async (newStatus)=>{
        ...
        if (!allowed.includes(newStatus)) {
            setStatusError(`Invalid status transition from "${lead.status}" to "${newStatus}"`);
            return;
        }
        setStatusError('');
        const now = new Date();
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$leadService$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].updateStatus(lead.id, newStatus);
        } catch (error) {
    ...
    const activitiesByDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LeadDetailPage.useMemo[activitiesByDate]": ()=>{
            if (!lead) return {};
            // Ensure activities is always an array
            const activities = lead.activities || [];
            return activities.reduce({
                "LeadDetailPage.useMemo[activitiesByDate]": (acc, activity)=>{
    ...
    if (loading || !lead) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
        children: "Loading..."
    }, void 0, false, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
        ...
        children: [
            ...
            activities// Sort descending by date
            .sort((a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()).map((group)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                    sx: {
                        mb: 2
                    },
                    children: [
...
_s(LeadDetailPage, "HMP4ZQAiHWwx9YwxPNdLzbdcRj0=", false, function() {
    return [
...
//# sourceMappingURL=app_c88e95ec._.js.map